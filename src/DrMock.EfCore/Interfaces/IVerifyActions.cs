...
namespace DrMock.EfCore.Interfaces
{
    public interface IVerifyActions
    {
        ...
        void VerifyAdded<T>(Expression<Func<T, bool>> match, Times? times = null) where T : class, new();
        ...
        void VerifyAddedAsync<T>(Expression<Func<T, bool>> match, Times? times = null) where T : class, new();
        ...
        void VerifyRangeAdded<T>(Expression<Func<IEnumerable<T>, bool>> matches, Times? times = null) where T : class, new();
        ...
        void VerifyRangeAddedAsync<T>(Expression<Func<IEnumerable<T>, bool>> matches, Times? times = null) where T : class, new();
        ...
        void VerifyUpdated<T>(Expression<Func<T, bool>> match, Times? times = null) where T : class, new();
        ...
        void VerifyRangeUpdated<T>(Expression<Func<IEnumerable<T>, bool>> matches, Times? times = null) where T : class, new();
        ...
        void VerifyRemoved<T>(Expression<Func<T, bool>> match, Times? times = null) where T : class, new();
        ...
        void VerifyRangeRemoved<T>(Expression<Func<IEnumerable<T>, bool>> match, Times? times = null) where T : class, new();
